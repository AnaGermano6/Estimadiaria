...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="150" height="311">
  ...
  <embed src="Botões_Utilizador.swf" width="150" height="311" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
          ...
          <p>&nbsp;</p></td>
        <td width="83%" align="center" valign="top"><table width="727" height="342" border="0" background="desenho do site/Quadrado_de_texto.png">
          <tr>
            <td height="338" valign="top"><table width="200" border="0">
                <tr>
                  <td><strong>Galeria</strong></td>
                </tr>
                <tr>
                  <td><iframe allowtransparency="true" src="fotos_galeria.php" name="main" width="715" marginwidth="0" height="305" marginheight="0" align="top" scrolling="Yes" frameborder="0" id="main" background="desenho do site/Quadrado_de_texto.png" ></iframe></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
...
<div align="center" class="style7 style4 style4"><span class="style4">© 2009 Estima Diária - Serviços de limpeza, Lda. / Elaborado: anasofiagermano@gmail.com</span>
  </p>
  </span>
  </p>
</div
