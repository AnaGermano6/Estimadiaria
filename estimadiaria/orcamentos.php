...
<table width="100%" height = "100%" border="0" cellspacing="0" cellpadding="0">
  <tr width="100%" height = "100%" align="center" valign="middle">
    <td width="100%" height = "100%" align="center" valign="middle"><table width="900" height="596" border="0" align="center" cellpadding="0" cellspacing="0" background="desenho do site/Fundo.jpg">
      <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','880','height','220','src','Banner','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Banner' ); //end AC code
      ...
      <tr>
        <td width="17%" height="321" align="center" valign="top"><table width="139" border="0" cellspacing="0" cellpadding="2">
          <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','285','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','scale','exactfit','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="50%" align="left" valign="top"><table width="21%" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
              <td width="35%"><span class="style2">Orçamentos</span></td>
              </tr>
            
        </table>          
          
          <div id="Serviços" class="TabbedPanels">
            <ul class="TabbedPanelsTabGroup">
              <li class="TabbedPanelsTab" tabindex="0">Limpeza</li>
              <li class="TabbedPanelsTab" tabindex="0">Jardinagem</li>
            </ul>
            <div class="TabbedPanelsContentGroup">
              <div class="TabbedPanelsContent">
                
                </form>
                <iframe allowtransparency="true" src="texto_orcamento_limpeza.php" name="main" width="690" marginwidth="0" height="280" marginheight="0" align="top" scrolling="Yes" frameborder="0" id="main" background="desenho do site/Quadrado_de_texto.png" ></iframe>
              </div>
              <div class="TabbedPanelsContent">
                <iframe allowtransparency="true" src="texto_orcamento_jardinagem.php" name="main" width="690" marginwidth="0" height="280" marginheight="0" align="top" scrolling="Yes" frameborder="0" id="main2" background="desenho do site/Quadrado_de_texto.png" ></iframe>
              </div>
            </div>
            </div></td>
      </tr>
...
<script type="text/javascript">
<!--
var TabbedPanels1 = new Spry.Widget.TabbedPanels("Serviços");
//-->
</script>
