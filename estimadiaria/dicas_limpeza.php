            ...
            <td align="left" valign="top">
              <form id="form1" name="form1" method="post" action="pesquisa.php">
                ...
                <table width="31%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td colspan="2"><span class="style1">Dicas de limpezas</span></td>
                    </tr>
                  <tr>
                    <td width="67%"><input type="text" name="pesquisa" id="textfield" /></td>
                    <td width="33%"><input type="submit" name="pesquisar" id="pesquisar" value="Pesquisar" /></td>
                  </tr>
                </table>
                <p><iframe allowtransparency="true" src="texto_dicas_limpeza.php" name="main" width="715" marginwidth="0" height="270" marginheight="0" align="top" scrolling="Yes" frameborder="0" id="main" background="desenho do site/Quadrado_de_texto.png" ></iframe>
                </p>
                </form>              </td>
          </tr>
        </table>        </td>
