...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','285','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','scale','exactfit','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="83%" valign="top"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0" background="desenho do site/Quadrado_de_texto.png">
          <tr>
            <td width="42%" height="339" align="left" valign="top"><table width="272" height="55" border="0">
                <tr>
                  <td width="262" height="51" colspan="2" align="left"><p class="style6">Contactos</p>
                    <p class="style6"><?php echo $row_Recordset1['contactos']; ?></p></td>
                </tr>
...
<div align="center" class="style7"><span class="style4">© 2009 Estima Diária - Serviços de limpeza, Lda. / Elaborado: anasofiagermano@gmail.com</span>
  </p>
  </span>
  </p>
</div>
