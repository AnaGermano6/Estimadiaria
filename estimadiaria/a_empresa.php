...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','285','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','scale','exactfit','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="83%" valign="top"><table width="728" height="345" border="0" align="center" background="desenho do site/Quadrado_de_texto.png">
          <tr>
            <td height="333" align="center" valign="top"><table width="711" border="0">
              <tr>
                <td width="416"><span class="style1">A Empresa</span></td>
              </tr>
              <tr>
                <td><span class="style4"><?php echo $row_Recordset1['a_empresa']; ?></span></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            <p align="justify">&nbsp;</p>
...
<div align="center"><span class="style4 style3">© 2009 Estima Diária - Serviços de limpeza, Lda. / Elaborado: anasofiagermano@gmail.com</span>
  </p>
  </span>
  </p>
</div>
