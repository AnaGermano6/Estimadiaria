...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','285','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','scale','exactfit','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <table width="728" height="345" border="0" background="desenho do site/Quadrado_de_texto.png">
          <tr>
            <td width="720" align="center" valign="top"><table width="697" border="0">
              <tr>
                <td width="709" height="41"><p align="justify" class="style1">Recursos Humanos</p>
                  <p align="justify" class="style1"><?php echo $row_Recordset1['recursos_humanos']; ?></p></td>
              </tr>
              <tr>
                <td height="60" align="center" valign="top"><p align="center"><a href="recrutamento.doc"><img src="Imagens/OfficeWord.png" width="40" height="40" /></a></p>                  </td>
              </tr>
