...
$carater_servico=$_POST["carater_servico"];
...
// a mensagem do email
$msg="- Nome: ".$nome."<br>- Assunto: ".$assunto."<br>- Mensagem: <br>-NIF: ".$NIF."<br>- Morada: ".$morada."<br>- Localidade: ".$localidade."<br>- Contacto: ".$contacto."<br>- Email: ".$email."<br>- Sugestão de data: ".$sugestao_horario."<br>- Carater do serviço: ".$carater_servico."<br>- Tipo de Infra Estrutura: ".$tipo_infra_estrutura."<br>- Produtos Includos: ".$produtos_incluidos."<br>- Descrição: ".$descricao."<br>- Observações do local: ".$observacoes;
