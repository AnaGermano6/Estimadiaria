...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE site SET servicos=%s WHERE numero=%s",
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="83%" align="left" valign="top"><table width="728" height="342" border="0" align="center" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
                <td height="338" align="left" valign="top"><p class="style1">Serviços
                    <?php
            //liga e escolhe a BD 
				include("ligarBD.php");
				
				//início de acção sobre a BD 
				$procurar="select servicos from site";
                  ...
                  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table align="center">
                      ...
                      <tr valign="baseline">
                        ...
                        <td><textarea name="servicos" cols="50"><?php echo htmlentities($row_Recordset1['servicos'], ENT_COMPAT, 'utf-8'); ?></textarea>                        </td>
                      </tr>
                      <tr valign="baseline">
                        <td nowrap="nowrap" align="right">&nbsp;</td>
