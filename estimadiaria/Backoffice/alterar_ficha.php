                ...
                <tr>
                  <td width="333"><table width="330" height="161" border="0">
                    ...
                    <tr>
                      ...
                      <td align="left"><label>
                        <input name="NIF" type="text" id="NIF" value="<?php echo $linha['NIF']; ?>" size="20" />
                      </label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td align="left"><label>
                        <input name="contacto" type="text" id="contacto" value="<?php echo $linha['contacto']; ?>" size="20"/>
                      </label></td>
                    </tr>
                  ...
                  <td width="348" valign="top"><table width="293" border="0">
                    ...
                    <tr>
                      ...
                      <td align="left"><input type="password" name="senha" id="senha" value="<?php echo $linha['senha']; ?>"/></td>
                    </tr>
                    <tr>
                      <td height="24" align="right"><strong>Repita a senha:</strong></td>
                      <td align="left"><input type="password" name="senha1" id="senha1" value="<?php echo $linha['senha']; ?>" /></td>
                    </tr>
                    <tr>
