...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <table width="726" height="344" border="0" align="center" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
          
            <td width="720" height="340" align="left" valign="top"><p class="style1">Dicas de limpezas
              ...
              <table width="277" border="0" align="center">
                <tr>
                  <td width="16" align="right" valign="middle"><img src="../Imagens/editar.png" width="16" height="16" /></td>
                  <td width="65" align="left" valign="middle"><span class="style2"><a href="editar_dicas.php">Editar</a></span></td>
                  <td width="21" align="right" valign="middle"><img src="../Imagens/ic-inserir.gif" width="21" height="22" /></td>
                  <td width="62" align="left" valign="middle"><span class="style3"><a href="inserir_dicas.php">Inserir</a></span></td>
                  <td width="25" align="right" valign="middle"><span class="style3"><img src="../Imagens/apagar.png" width="24" height="24" /></span></td>
                  <td width="62" align="left" valign="middle"><span class="style3"> <a href="apagar_dicas.php">Apagar</a></span></td>
                </tr>
              </table>
              <p class="style2">&nbsp;</p>
              <p class="style2">&nbsp;</p>
...
<div align="center"><span class="style4">© 2009 Estima Diária - Serviços de limpeza, Lda. / Elaborado:<font color="#999999"> anasofiagermano@gmail.com</font></span>
  </p>
  </span>
  </p>
</div>
