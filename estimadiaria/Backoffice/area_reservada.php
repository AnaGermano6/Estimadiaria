...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <table width="726" height="344" border="0" align="center" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
            ...
            <td width="720" height="340" align="left" valign="top"><p class="style1">Area Reservada</p>
              <p class="style2">&nbsp;</p>
              <table width="188" border="0" align="center">
                <tr>
                  <td width="21" align="right" valign="middle"><img src="../Imagens/certo.png" width="24" height="24" /></td>
                  <td width="62" align="left" valign="middle"><a href="activacao.php">Activar</a></td>
                  <td width="25" align="right" valign="middle"><span class="style3"><img src="../Imagens/apagar.png" width="24" height="24" /></span></td>
                  <td width="62" align="left" valign="middle"><span class="style3"> <a href="apagar_area.php">Apagar</a></span></td>
                </tr>
              </table>
              <p class="style2">&nbsp;</p>
              <p class="style2">&nbsp;</p>
