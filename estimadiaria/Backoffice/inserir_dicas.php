...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO dicas_limpeza (num, titulo, titulo_descricao) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['num'], "int"),
                       GetSQLValueString($_POST['titulo'], "text"),
                       GetSQLValueString($_POST['titulo_descricao'], "text"));

  mysql_select_db($database_bd, $bd);
  $Result1 = mysql_query($insertSQL, $bd) or die(mysql_error());

  $insertGoTo = "editar_dicas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_bd, $bd);
$query_Recordset1 = "SELECT * FROM dicas_limpeza";
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                <table align="center">
                  <tr valign="baseline">
                    ...
                    <td><input type="hidden" name="num" value="" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
                  ...
                  <tr valign="baseline">
                    ...
                    <td><input type="text" name="titulo_descricao" value="" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">&nbsp;</td>
