...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE site SET contactos=%s WHERE numero=%s",
...
<table width="100%" height = "100%" border="0" cellspacing="0" cellpadding="0">
  <tr width="100%" height = "100%" align="center" valign="middle">
    ...
    <table width="900" height="599" border="0" align="center" cellpadding="0" cellspacing="0" background="../desenho do site/Fundo_backoffice.jpg">
      <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <table width="97%" height="345" border="0" align="left" cellpadding="0" cellspacing="0" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
            <td height="338" align="left" valign="top"><p class="style1"> Contactos
              <?php
            //liga e escolhe a BD 
				include("ligarBD.php");
				
				//início de acção sobre a BD 
				$procurar="select contactos from site";
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                <table align="center">
                  ...
                  <tr valign="baseline">
                    ...
                    <td><textarea name="contactos" cols="50"><?php echo htmlentities($row_Recordset1['contactos'], ENT_COMPAT, 'utf-8'); ?></textarea>
                    </td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">&nbsp;</td>
