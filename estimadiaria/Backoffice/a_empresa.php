...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE site SET a_empresa=%s, servicos=%s, recursos_humanos=%s, contactos=%s, questionario=%s WHERE numero=%s",
                       GetSQLValueString($_POST['a_empresa'], "text"),
                       GetSQLValueString($_POST['servicos'], "text"),
                       GetSQLValueString($_POST['recursos_humanos'], "text"),
                       GetSQLValueString($_POST['contactos'], "text"),
                       GetSQLValueString($_POST['questionario'], "text"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE site SET numero=%s WHERE a_empresa=%s",
                       GetSQLValueString($_POST['numero'], "undefined"),
                       GetSQLValueString($_POST['a_empresa'], "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE site SET a_empresa=%s WHERE numero=%s",
                       GetSQLValueString($_POST['a_empresa'], "text"),
                       GetSQLValueString($_POST['numero'], "int"));
...
<table width="100%" height = "100%" border="0" cellspacing="0" cellpadding="0">
  <tr width="100%" height = "100%" align="center" valign="middle">
    <td width="100%" height = "100%" align="center" valign="middle"><table width="900" height="598" border="0" align="center" cellpadding="0" cellspacing="0" background="../desenho do site/Fundo_backoffice.jpg">
      <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','880','height','220','src','Banner','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Banner' ); //end AC code
      ...
      <tr>
        <td width="17%" height="366" valign="top"><table width="139" border="0" cellspacing="0" cellpadding="2">
          <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="83%" valign="top"><table width="724" height="342" border="0" cellpadding="2" cellspacing="0" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
            <td width="710" height="342" align="left" valign="top"><p class="style1">A Empresa
              <?php
            //liga e escolhe a BD 
				include("ligarBD.php");
				
				//início de acção sobre a BD 
				$procurar="select a_empresa from site";
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                <table align="center">
                  ...
                  <tr valign="baseline">
                    ...
                    <td><textarea name="a_empresa" cols="50"><?php echo htmlentities($row_Recordset1['a_empresa'], ENT_COMPAT, 'utf-8'); ?></textarea>                    </td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">&nbsp;</td>
...
<p align="center"><span class="style4">© 2009 Estima Diária - Serviços de limpeza, Lda. / Elaborado:<font color="#999999"> anasofiagermano@gmail.com</font></span></p>
</body>
</html>
<?php
