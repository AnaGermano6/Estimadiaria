...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','150','height','275','src','Botões','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','Botões' ); //end AC code
        ...
        <td width="83%" align="left" valign="top"><table width="724" height="345" border="0" cellpadding="2" cellspacing="0" background="../desenho do site/Quadrado_de_texto.png">
          <tr>
            <td width="710" height="338" align="left" valign="top">
            <p><span class="style1">Area Reservada</span></p>
            <iframe allowtransparency="true" src="apagar_area1.php" name="main" width="715" marginwidth="0" height="299" marginheight="0" align="top" scrolling="Yes" frameborder="0" id="main" background="desenho do site/Quadrado_de_texto.png" ></iframe>
